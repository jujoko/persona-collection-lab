...
그 말이 끝나자 둘 다 한동안 말이 없었다.`,
    ...
    // ── E511: 후배의 질문 (정체성 점검) — 공통 ──────────────────────────────
    {
      ...
      summary: `입사 6개월 차 후배 이 사원이 점심을 먹다가 뜬금없이 물었다.
"선배는 왜 이 일을 선택했어요?"
대답하려다 말이 막혔다. 이 질문에 제대로 답한 적이 없었다.
후배는 기다리고 있다.`,

      actions: [
        {
          id: "answers_honestly",
          label: "솔직하게 말한다. 좋은 이유만은 아니었다고",
          outcome: `후배가 생각보다 오래 들었다. '그렇군요'라고만 했다.
그 짧은 대답이 이상하게 묵직하게 남았다.`,
          sets: { mentored_someone: true }
        },
        {
          id: "gives_positive_spin",
          label: "보람 있고 의미 있다는 식으로 좋게 말한다",
          outcome: `후배가 고개를 끄덕였다. 내가 한 말이 전부 사실인지는 모르겠다.
원하는 대답을 들은 것 같기도 하고, 아닌 것 같기도 했다.`,
          sets: { mentored_someone: true }
        },
        {
          id: "admits_not_knowing",
          label: "사실 나도 잘 모르겠다고 말한다",
          outcome: `후배가 웃었다. '저도 그래서 물어본 거예요'라고 했다.
둘 다 모르는 채로 밥을 마저 먹었다. 예상치 못한 대답이었다.`,
          sets: { mentored_someone: true }
        }
      ]
    },

    // ── E512: 내 이름이 들어간 서류 (책임 딜레마) — 공통 ──────────────────
    {
      id: "E512",
      arc: "arc5",
      title: "내 이름이 들어간 서류",
      type: "accountability_dilemma",
      tags: ["책임", "서류", "실수"],
      requires: {},
      excludes: {},
      weight: 1.0,

      summary: `두 달 전, 팀장이 제출한 사업 계획서에 팀원 전체 서명이 들어갔다.
바쁜 시기였다. 내용을 제대로 읽지 않고 서명했다.
오늘 감사팀에서 연락이 왔다. 그 보고서의 수치가 허위였다는 결과가 나왔다고.
서명자 전원이 소명을 요구받았다. 내 이름이 거기 있다.`,

      actions: [
        {
          id: "admits_ignorance",
          label: "내용을 확인하지 않고 서명한 사실을 솔직히 말한다",
          outcome: `감사관이 기록했다. 무지가 면죄부가 되는지는 알 수 없다.
하지만 거짓말보다는 나을 것이다. 아마도.`,
          sets: {}
        },
        {
          id: "claims_not_involved",
          label: "서명만 했을 뿐 내용 작성에는 관여하지 않았다고 주장한다",
          outcome: `팀장의 얼굴이 굳었다. 사실이었지만 그 말이 결국 팀장에게로 향한다는 걸 알면서 한 말이었다.`,
          sets: { reputation: "medium" }
        },
        {
          id: "reviews_situation_quietly",
          label: "소명서 제출 전에 내용을 꼼꼼히 검토하고 법적 조언을 구한다",
          outcome: `변호사가 '서명 자체도 책임'이라고 했다. 알고 싶지 않던 말이었다.
하지만 알고 대응하는 것과 모르는 채로 당하는 건 다르다.`,
          sets: {}
        }
      ]
    },
